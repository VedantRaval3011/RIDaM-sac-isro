  ...
  setup(props, { emit }) {
    ...
    watch(() => props.initialData, (newVal, oldVal) => {
      if (newVal) {
        ...
        yLl.value = newVal.yLl;
        xLl.value = newVal.xLl;
        yLr.value = newVal.yLr;
        xLr.value = newVal.xLr;
        xUl.value = newVal.xUl;
        yUl.value = newVal.yUl;
        xUr.value = newVal.xUr;
        yUr.value = newVal.yUr;
      }
    }, { immediate: true });
    ...
    if (selectedData) {
      ...
      const jsonyLl = selectedData.metadata.y_ll;
      const jsonxll = selectedData.metadata.x_ll;
      const jsonylr = selectedData.metadata.y_lr; 
      const jsonxlr =selectedData.metadata.x_lr;
      const jsonxul = selectedData.metadata.x_ul;
      const jsonyul = selectedData.metadata.y_ul;
      const jsonxur = selectedData.metadata.x_ur;
      const jsonyur = selectedData.metadata.y_ur;
