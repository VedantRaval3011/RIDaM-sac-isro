...
export default {
  ...
  watch(() => props.initialData, (newVal, oldVal) => {
      if (newVal) {
        ...
        dpb.value = newVal.dpb;
        ogsc.value = newVal.ogsc;
        SourceScale.value = newVal.SourceScale;
        SourceDate.value = newVal.SourceDate;
        Lineage.value = newVal.Lineage;
        cn.value = cn.Purpose;
        ad.value = newVal.ad;       
      }
    }, { immediate: true });
    ...
    if(props.initialData && props.initialData.id){
      ...
      CorrectAd.value = true;
      CorrectOgsc.value = true;
      CorrectCn.value = true;
      Correctdpb.value = true;
      CorrectLineage.value = true;
      CorrectSourceScale.value = true;
    ...
    if (selectedData) {
      ...
      const jsonDpb = selectedData.metadata.dpb;
      const jsonOgsc = selectedData.metadata.osgc;
      const jsonSourceScale = selectedData.metadata.source_scale; 
      const jsonSourceDate =selectedData.metadata.source_date;
      const jsonLineage = selectedData.metadata.use_constraints;
      const jsonCn = selectedData.metadata.corporate_name;
      const jsonAd = selectedData.metadata.corporate_address;
      
      // Setting initial values based on JSON data
      dpb.value = jsonDpb;
      ogsc.value = jsonOgsc;
      SourceScale.value = jsonSourceScale;
      SourceDate.value = jsonSourceDate;
      Lineage.value = jsonLineage;
      cn.value = jsonCn;
      ad.value = jsonAd;
      
      
      console.log("Source date:," , SourceDate.value);
    } else {
